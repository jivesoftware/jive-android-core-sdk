...
public class JiveCoreHttpClientAuthUtils {
     ...
     */
    @Nonnull
    public static <H extends AbstractHttpClient> H initHttpClientAuth(@Nonnull H httpClient, @Nonnull JiveCoreTokenEntityStore tokenEntityStore, @Nonnull final JiveCoreTokenEntityRefresher tokenEntityRefresher) {
